...
ggsave(path = "../output/lodes_maps/flows", device = "png", filename = "in_county_flows_2017", plot = last_plot())
...
ggsave(path = "../output/lodes_maps/flows", device = "png", filename = "in_county_flows_2016", plot = last_plot())
