...
saveRDS(county_lines, "../data/acs_leaflet_countylines.Rds")
...
race_div_2018_leaf <- leaflet(race_div_2018) %>%
  ...
  addPolygons(
    ...
    label = ~lapply(paste(sep = "", 
                          substr(race_div_2018$NAME, 20, 60), "<br/>",
                          substr(race_div_2018$NAME, 1, 17), 
                          "<br/>Margins of error: ",
