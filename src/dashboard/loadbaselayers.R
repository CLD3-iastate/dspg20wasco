...
doc <- osmdata_xml(q, "~/git/DSPG2020/wasco/data/shps/big_streets.osm")
...
doc <- osmdata_xml(q, "~/git/DSPG2020/wasco/data/shps/med_streets.osm")
...
doc <- osmdata_xml(q, "~/git/DSPG2020/wasco/data/shps/small_streets.osm")
