...
ggsave(path = "../output/lodes_maps/flows", device = "png", filename = "in_county_flows_2017.png", plot = last_plot())
...
ggsave(path = "../output/lodes_maps/flows", device = "png", filename = "in_county_flows_2016.png", plot = last_plot())
...
ggsave(path = "../output/lodes_maps/flows", device = "png", filename = "in_county_flows_2015.png", plot = last_plot())
