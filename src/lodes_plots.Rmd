...
ggsave(path = "../output/lodes_maps/flows", device = "png", filename = "in_county_flows_2015", plot = last_plot())
...
ggsave(path = "../output/lodes_maps/2017", device = "png", filename = "alljobs_2017", plot = alljobs_2017)
...
goodsjobs_2017 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2017", device = "png", filename = "goodsjobs_2017", plot = goodsjobs_2017)
...
utilsjobs_2017 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2017", device = "png", filename = "utilsjobs_2017", plot = utilsjobs_2017)
...
servicejobs_2017 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2017", device = "png", filename = "servicejobs_2017", plot = servicejobs_2017)
...
alljobs_2016 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2016", device = "png", filename = "alljobs_2016", plot = alljobs_2016)
...
goodsjobs_2016 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2016", device = "png", filename = "goodsjobs_2016", plot = goodsjobs_2016)
...
utilsjobs_2016 <- ggplot(wasco_county) +
  ...
  ggtitle("Total number of jobs in Trade, Transportation,\n and Utilities industry sectors\n in South Wasco County by Census Block in 2016") +
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2016", device = "png", filename = "utilsjobs_2016", plot = utilsjobs_2016)
...
servicejobs_2016 <- ggplot(wasco_county) +
  ...
  ggtitle("Total number of jobs in All Other Services industry sectors\n in South Wasco County by Census Block in 2016") +
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2016", device = "png", filename = "servicejobs_2016", plot = servicejobs_2016)
```
...
alljobs_2015 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2015", device = "png", filename = "alljobs_2015", plot = alljobs_2015)
...
goodsjobs_2015 <- ggplot(wasco_county) +
  ...
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2015", device = "png", filename = "goodsjobs_2015", plot = goodsjobs_2015)
...
utilsjobs_2015 <- ggplot(wasco_county) +
  ...
  ggtitle("Total number of jobs in Trade, Transportation,\n and Utilities industry sectors\n in South Wasco County by Census Block in 2015") +
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2015", device = "png", filename = "utilsjobs_2015", plot = utilsjobs_2015)
...
servicejobs_2015 <- ggplot(wasco_county) +
  ...
  ggtitle("Total number of jobs in All Other Services industry sectors\n in South Wasco County by Census Block in 2015") +
  labs(fill = "Number of Jobs")
ggsave(path = "../output/lodes_maps/2015", device = "png", filename = "servicejobs_2015", plot = servicejobs_2015)
```
