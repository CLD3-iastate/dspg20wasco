...
```{r}
filter(fam_stab_moe, year == 2015)$family_married_parent_perc_moe
```
...
fam_stab_2015_leaf <- leaflet(fam_stab_2015) %>%
  ...
  addPolygons(
    ...
    label = ~lapply(paste(sep = "", 
                          ...
                          "<br/>Margins of error: ",
                          round(filter(fam_stab_moe, 
                                       year == 2015)$family_nonfamily_household_perc_moe, 
                                1), "%<br/>",
                          "<strong> Percent Married: <strong>", 
                          round(family_nonfamily_household_perc, 1), "<strong>%"),
                    htmltools::HTML)) %>%
  addPolylines(
    data = south_wasco_points,
    color = "#ffce9e",
