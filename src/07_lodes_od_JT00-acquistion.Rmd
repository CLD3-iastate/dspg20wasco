...
write.csv(jobs_all_2017, "../data/lodes/agg/jobs_all_2017.csv")

jobs_all_2016 <- wasco16 %>%
  group_by(createdate, w_geocode_tract, h_geocode_tract) %>% 
  summarise(S000 = sum(S000), 
            SA01 = sum(SA01), 
            SA02 = sum(SA02), 
            ...
            SI02 = sum(SI02), 
            SI03 = sum(SI03))
write.csv(jobs_all_2016, "../data/lodes/agg/jobs_all_2016.csv")


jobs_all_2015 <- wasco15 %>%
  group_by(createdate, w_geocode_tract, h_geocode_tract) %>% 
  summarise(S000 = sum(S000), 
            SA01 = sum(SA01), 
            SA02 = sum(SA02), 
            ...
            SI02 = sum(SI02), 
            SI03 = sum(SI03))
write.csv(jobs_all_2015, "../data/lodes/agg/jobs_all_2015.csv")
